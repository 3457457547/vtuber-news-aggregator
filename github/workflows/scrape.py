...
def parse_timeline(html):
    ...
    <div class="timeline">
        <div class="nhkecr27">
            <p class="time">10/23 02:05</p>
            <p class="article"><a href="..." target="_blank">記事タイトル</a></p>
            <p class="site"><a href="...">にじホロ速</a></p>
        </div>
        ...
    </div>
    """
...
def render_ad_block():
    """広告ブロック（後でnendコードに置き換え）"""
    return """<div class="ad-block">
<!-- nend広告コードをここに挿入 -->
<!-- 審査通過後、以下の形式で挿入:
<script type="text/javascript">
var nend_params = {"media":12345,"site":123456,"spot":123456,"type":1,"oriented":1};
</script>
...
def main():
    ...
    print(f"🆕 新規記事: {len([i for i in merged_items if i.get('id') not in {j.get('id') for j in old_items}])}件")
    print("=" * 60)
